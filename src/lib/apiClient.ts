...
export const api = {
  ...
  requestChangePhoneCode: (newPhone: string) => requestJson<{ ok: true; devCode?: string; expiresInSeconds: number }>('/api/me/change-phone/request-code', {
    method: 'POST',
    body: JSON.stringify({ newPhone }),
  }),
  verifyChangePhoneCode: (newPhone: string, code: string) => requestJson<{ user: any }>('/api/me/change-phone/verify', {
    method: 'POST',
